...
(function (global) {
    'use strict';
    let comunes = ['MARIA', 'MA', 'MA.', 'JOSE', 'J', 'J.'];
    ...
    * Función principal que genera el CURP.
     * Main function that generates the CURP.
    ...
    */
    function generaCurp(param) {
        let inicial_nombre, vocal_apellido, posicion_1_4, posicion_14_16, curp, primera_letra_paterno, primera_letra_materno, nombres, nombre_a_usar, pad;
